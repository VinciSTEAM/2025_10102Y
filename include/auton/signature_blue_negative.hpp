...
void signature_blue_negtive(){
    ...
    chassis.turnToHeading(335, 800, {.maxSpeed = 127}, false); 
    chassis.waitUntilDone();
 
    chassis.moveDistance(21, 1000, {.maxSpeed = 127}, false);
    chassis.moveToPoint(16, 31, 900, {.forwards = false, .maxSpeed = 100}, false);
    chassis.turnToHeading(0, 500, {.maxSpeed = 127}, false);
    chassis.moveDistance(22, 1200, {.maxSpeed = 127}, false);
    ...
    chassis.turnToHeading(37, 800, {.maxSpeed = 127}, false);
